...
class CalendarEventForm extends TWindow
{
    ...
    public function __construct()
    {
        ...
        $name = new TDBCombo('name', 'clientes', 'City', 'id', 'name');
      ...
      //  $title          = new TEntry('title');
        ...
        $title  = new TCombo('title ');
$title ->addItems(array('<FONT FACE=Arial COLOR="#FF0000">Escova Definitiva</FONT>'=>'Escova definitiva', '<FONT FACE=Arial COLOR="#8B0000">Retoque de Dft</FONT>'=>'Retoque de escova definitiva',  '<FONT FACE=Arial COLOR="#D2691E">Mechas</FONT>'=>'Mechas','<FONT FACE=Arial COLOR="#8A2BE2">Corte Feminino</FONT>'=>'Corte Feminino','<FONT FACE=Arial COLOR="#FF4500">Corte e Hidratação</FONT>'=>'Corte e Hidratação','Corte Masculino'=>'Corte Masculino','<FONT FACE=Arial COLOR="#006400">Progressiva</FONT>'=>'Progressiva','<FONT FACE=Arial COLOR="#006400">Selagem</FONT>'=>'Selagem','<FONT FACE=Arial COLOR="#8B4513">Tintura</FONT>'=>'Tintura','<FONT FACE=Arial COLOR="#9400D3">Pé e Mão</FONT>'=>'Pé e Mão','<FONT FACE=Arial COLOR="#9400D3">Só Pé</FONT>'=>'Só Pé','<FONT FACE=Arial COLOR="#9400D3">Só e Mão</FONT>'=>'Só Mão','<FONT FACE=Arial COLOR="#2F4F4F">sombrancelha</FONT>'=>'sombrancelha','<FONT FACE=Arial COLOR="#8B4513">somb Henna</FONT>'=>'somb Henna','<FONT FACE=Arial COLOR="#A52A2A">Massagem</FONT>'=>'Massagem','<FONT FACE=Arial COLOR="#A52A2A">Outros Serviços</FONT>'=>'Outros Serviços','<FONT FACE=Arial COLOR="#A52A2A">liimpeza de pele</FONT>'=>'Limpeza de Pele','<FONT FACE=Arial COLOR="#A52A2A">Depilação</FONT>'=>'Depilção','<FONT FACE=Arial COLOR="#A52A2A">Depilação</FONT>'=>'Lembrete','<FONT FACE=Arial COLOR="#A52A2A">Depilação</FONT>'=>'Lembrete',) );


        $description    = new TText('description');
        
        $precoservico  = new TEntry('precoservico');
       // $color->setValue('#000000');        
        $precoproduto   = new TEntry('precoproduto');
       ...
       $name->setSize(100);
        ...
        $description->setSize(200, 50);
         $precoservico->setSize(100, 10);
          $precoproduto->setSize(100, 10);
        ...
        $this->form->addFields( [new TLabel('Description:')], [$description] );
           $this->form->addFields( [new TLabel('Preço do Serviço:')], [$precoservico] );
              $this->form->addFields( [new TLabel('preço dos produtos:')], [$precoproduto] );
    ...
    public function onSave()
    {
        try
        {
            ...
            $object->description = $data->description;
              $object->precoservico = $data->precoservico;
                $object->precoproduto = $data->precoproduto;
    ...
    public function onEdit($param)
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $data->precoservico = $object->precoservico;
                $data->precoproduto = $object->precoproduto;
